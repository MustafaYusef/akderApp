...
import 'package:akhder_app/ui/driver/driverOrderDetails.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

Widget driverArchiveOrderCard(DriverOrder item) {
  // TendersController controller = Get.find();
  return InkWell(
    onTap: () {
      Get.to(DriverOrderDetailsScreen(DriverCurrentOrder(
          id: item.id,
